...
public class Pager {
	 ...
	 * :네비게이션(오른쪽 화살표)의 유무 pageStart : 페이지의 시작 pageEnd : 페이지의 마지막 blockPage : 현재
	 * 블락번호 pageCount : 전체 개수에서 페이징 수만큼 나눈 페이지의 개수 blockCount : 페이지의 개수에서 페이지 수만큼 나눈
	...
	public void pageSetting(int page) {

		sqlStartPage = (this.page - 1) * pagingSize;
	}
